...
win32 {
    BOOST_LIB_SUFFIX=-mgw48-mt-1_56
    BOOST_INCLUDE_PATH=C:/libgcc/boost_1_56_0
    BOOST_LIB_PATH=C:/libgcc/boost_1_56_0/stage/lib
    BDB_INCLUDE_PATH=C:/libgcc/db-4.8.30.NC/build_unix
    BDB_LIB_PATH=C:/libgcc/db-4.8.30.NC/build_unix
    OPENSSL_INCLUDE_PATH=C:/libgcc/openssl-0.9.8/include
    OPENSSL_LIB_PATH=C:/libgcc/openssl-0.9.8/lib
    MINIUPNPC_INCLUDE_PATH=C:/libgcc
    MINIUPNPC_LIB_PATH=C:/libgcc/miniupnpc
}
...
LIBS += -lssleay32 -llibeay32 -ldb_cxx$$BDB_LIB_SUFFIX
