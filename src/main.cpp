...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = nStartSubsidy;
		...
		if(nHeight > 1600000) nSubsidy = 8; //kmj 140만블럭부터 16
		else if(nHeight > 1500000) nSubsidy = 16; //kmj 140만블럭부터 16
    else if(nHeight > 1300000) nSubsidy = 30; //kmj 140만블럭부터 30개
    else if(nHeight > 1200000) nSubsidy = 60; //kmj 120만블럭부터 60개

		nSubsidy >>= (nHeight / 2000000); // kmj 반감기도입200만블럭
		if(nSubsidy<2)nSubsidy=1;//최소 1개씩 주자
